...
export class ChangeTypePhoneInvoice1694764939204 implements MigrationInterface {
    name = 'ChangeTypePhoneInvoice1694764939204'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`invoice\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`invoice\` ADD \`phone\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`invoice\` DROP COLUMN \`phone\``);
        await queryRunner.query(`ALTER TABLE \`invoice\` ADD \`phone\` int NOT NULL`);
